#ifndef AST_BINARY_DIVISION_HPP
#define AST_BINARY_DIVISION_HPP

#include "ast_header/ast_Base.hpp"

class BinaryDivision : public Base {
public:
    BinaryDivision(BasePtr left, BasePtr right);
    virtual ~BinaryDivision();
